...
def login_page():
    set_background('/app/images/cube.jpg')  # 이미지 파일 경로 수정
    st.title("")
...
def sign_up_page():
    set_background('/app/images/neon.jpg')
    st.header("")
    st.title("Team PROJECT - 2023 :sunglasses:")
...
def main_page():
    set_background('/app/images/min.jpg')
    st.header("")
    st.title("Team PROJECT - 2023 :sunglasses:")
    st.caption("Welcome !!! :smile:")
...
def modify_page():
    set_background('/app/images/king.jpg')
    st.header("")
    st.title("Team PROJECT - 2023 :sunglasses:")
    st.caption("Streamlit WebPage - Welcome !!! :smile:")
    st.header("")
...
def new_page():
    # 원하는 배경 이미지로 설정
    set_background('/app/images/robot.jpg')
